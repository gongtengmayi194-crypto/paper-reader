...
```markdown
## Resources
- Report templates: `references/report-template-paper-deep.md`, `references/report-template-code-module.md`, `references/report-template-quiz.md`
...
预期：看到以下 4 个文件：
- `annotation-guide.md`
- `report-template-paper-deep.md`
- `report-template-quiz.md`
- `report-template-code-module.md`
...
- [ ] 现有 quick/core/full 档位仍可用（不依赖旧模板文件）
